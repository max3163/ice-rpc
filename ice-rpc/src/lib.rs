...
// ── Internal re-exports (used by the generated code) ───────────────
// These types are public for the procedural macro but are not
// part of the user API. They are hidden from the documentation.
#[doc(hidden)]
pub use blackboard::{create_node_blackboard, list_services};
#[doc(hidden)]
pub use hub::{NodeHub, RequestHandler, ResponseHandler};
#[doc(hidden)]
pub use node_discovery::{DiscoveryEvent, NodeDiscovery, NodeRecord};
#[doc(hidden)]
pub use node_lock::{
...
#[doc(hidden)]
pub use registry_listener::spawn as spawn_node_registry_listener;
#[doc(hidden)]
pub use registry_notify::{announce_dead_node, announce_node_ready};
