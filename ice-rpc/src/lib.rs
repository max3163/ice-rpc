...
//! | `gen` | Internal facade for the code generated by `#[service]` (doc-hidden) |
...
pub use types::{
    caller_pid_from_cid, channel, fmt_correlation_id, fmt_correlation_id_short, normalize_event,
    normalize_observable, normalize_stream, Event, EventKind, NodeId, Observable, RpcError,
    RpcHeader, Sender, StaticString, Stream, TakeOneError, BLACKBOARD_MAX_READERS,
    DEFAULT_TOPIC_BUFFER_SIZE, INITIALIZE_ALL_TIMEOUT_SECS, INIT_RETRY_INTERVAL_MS,
    LARGE_TOPIC_BUFFER_SIZE, METHOD_NAME_LEN, PROTOCOL_VERSION, PUBLISHER_DEFAULT_MAX_SLICE_LEN,
    PUBLISHER_LARGE_MAX_SLICE_LEN, RPC_CALL_TIMEOUT_SECS, SERVER_READY_POLL_MS, WAITSET_TIMEOUT_US,
};
